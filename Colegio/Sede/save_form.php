...
<h1>Agregar Sede</h1>
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="idSede" id="idSede" placeholder= "Ingrese id">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="text"  class="form-control" name="idColegio" id="idColegio" placeholder= "idColegio">
    </div>
        <input type="submit" class="btn btn-primary" value="Guardar Sede">
        <br>
        <br>
